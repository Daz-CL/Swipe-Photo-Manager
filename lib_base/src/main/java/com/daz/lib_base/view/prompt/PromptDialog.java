package com.daz.lib_base.view.prompt;
...
import com.daz.lib_base.view.prompt.interfaze.OnAdClickListener;
import com.daz.lib_base.view.prompt.interfaze.PromptDialogDismissListener;
...
public class PromptDialog {
    ...
    private PromptDialogDismissListener dismissListener;
...
//                outAnim.setStartOffset(delayTime);
    ...
    private void showAlert(String text, boolean withAnim, PromptButton... button) {
        if (button.length > 2) {
            XLog.i(TAG, "showAlert: " + promptView.getScrollY());
...
//        window.closeAllPanels();
    ...
    public void setOnDismissListener(PromptDialogDismissListener dismissListener) {
